...
This project targets `net10.0`, `netstandard2.0` and `net45`. Due to .Net 4.5.2 being the currently latest supported version
...
The library supports `net10.0`, `netstandard2.0` as well as `net45` and `net40`. Binaries for the full framework are separately generated for older build tools that do not properly integrate with .NET Standard.
